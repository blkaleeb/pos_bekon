...
class PembelianController extends Controller
{
    ...
    return datatables()
      ...
      ->addColumn('aksi', function ($pembelian) {
        return '
                  <div class="btn-group">
                      <a href="' .
          route('barang_datang.show', $pembelian->id_pembelian) .
          '" class="btn btn-xs btn-success btn-flat">Confirm kedatangan</a>
                      <button onclick="showDetail(`' .
          route('pembelian.show', $pembelian->id_pembelian) .
          '`)" class="btn btn-xs btn-info btn-flat"><i class="fa fa-eye"></i></button>
                      <button onclick="deleteData(`' .
          route('pembelian.destroy', $pembelian->id_pembelian) .
  ...
  {
    $detail = BarangDatang::with('pembelian', 'pembelian_detail', 'pembelian_detail.produk')
